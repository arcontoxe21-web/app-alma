...
async function getVetAIResponse(q) {
    const intro = "Soy la **Dra. Alma (v7.1)**, especialista en medicina de urgencias de la Manada.";
    ...
    function init() {
        ...
        window.sendVetMessage = async (predefinedText) => {
            ...
            typing.innerHTML = '<i class="fa-solid fa-circle-notch fa-spin"></i> Dra. Alma (v7.1) está escribiendo...';
    ...
    const InstallApp = {
        ...
        init() {
            ...
            if (typeof showToast === 'function') showToast("Sistema v7.1 (PATH FIX) Iniciado", "success");
    ...
    if ('serviceWorker' in navigator) {
        window.addEventListener('load', () => {
            navigator.serviceWorker.register('./sw.js')
                .then(registration => {
                    console.log('✅ SW v7.1 Registered:', registration);
